const d="https://labhive.app/logo.svg",e="https://labhive.app/";function p({title:t,body:i,ctaLabel:l="View in LabHive →",ctaUrl:n=e,prefsUrl:r=e,orgContact:x=null}){const o=x!=null&&x.contact_email?`
        <tr>
          <td style="padding:0 36px 24px;">
            <div style="background:#f0f9f6;border:1px solid #c6e6d8;border-radius:8px;padding:14px 16px;text-align:center;">
              ...
              `+(x.contact_name?'<div style="font-size:13px;font-weight:600;color:#111827;margin-bottom:3px;">'+a(x.contact_name)+"</div>":"")+`
              <a href="mailto:`+a(x.contact_email)+'" style="font-size:13px;color:#1D9E75;text-decoration:none;font-weight:500;">'+a(x.contact_email)+`</a>
            </div>
          </td>
      ...
      <table width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.10);">
        ...
        <tr>
          <td style="background:#0d47a1;padding:28px 32px 24px;text-align:center;">
            <img src="`+d+`" width="72" height="72" alt="LabHive logo" style="display:block;margin:0 auto 12px;border:0;">
        ...
        <tr>
          <td style="padding:32px 36px 24px;">
            <h2 style="margin:0 0 14px;font-size:17px;font-weight:700;color:#111827;line-height:1.4;">`+a(t)+`</h2>
            <p style="margin:0 0 28px;font-size:14px;color:#4B5563;line-height:1.7;">`+a(i)+`</p>

            <!-- CTA button -->
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:14px;">
              <tr><td align="center">
                <a href="`+n+'" style="display:inline-block;background:#1D9E75;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;padding:13px 32px;border-radius:8px;letter-spacing:0.1px;">'+a(l)+`</a>
              </td></tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr><td align="center">
                <a href="`+r+`" style="font-size:12px;color:#6B7280;text-decoration:underline;">Manage notification preferences</a>
              </td></tr>
            </table>
          </td>
        </tr>
...
</html>`}function a(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}export{p as b};
