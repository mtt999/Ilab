const s="https://labhive.app/logo.svg",i="https://labhive.app/app";function c({title:t,body:o,ctaLabel:n="View in LabHive →",ctaUrl:r=i,prefsUrl:l=i,orgContact:a=null,credentials:e=null}){const d=e?`
        <tr>
      ...
      <table width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.10);">
        ...
        <tr>
          <td style="background:#0d47a1;padding:28px 32px 24px;text-align:center;">
            <img src="`+s+`" width="72" height="72" alt="LabHive logo" style="display:block;margin:0 auto 12px;border:0;">
