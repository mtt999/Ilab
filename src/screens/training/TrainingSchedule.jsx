...
async function sendTrainingEmail(userId, prefKey, subject, title, body) {
  ...
  const htmlBody = buildEmailHtml({ title, body, ctaLabel: 'View Training in LabHive →', ctaUrl: 'https://labhive.app/?screen=training', prefsUrl: 'https://labhive.app/?screen=profile', orgContact })
