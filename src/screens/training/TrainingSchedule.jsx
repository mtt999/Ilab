...
async function sendTrainingEmail(userId, prefKey, subject, title, body) {
  ...
  const htmlBody = buildEmailHtml({ title, body, ctaLabel: 'View Training in LabHive →', ctaUrl: 'https://labhive.app/app?screen=training', prefsUrl: 'https://labhive.app/app?screen=profile', orgContact })
