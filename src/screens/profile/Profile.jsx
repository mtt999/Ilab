          ...
          <form onSubmit={e => { e.preventDefault(); savePassword() }} autoComplete="on">
            ...
            <div className="grid-2">
              <div className="field">
                ...
                <PasswordInput show={showPinNew} onToggle={() => setShowPinNew(s => !s)} value={pinForm.newPin} onChange={e => { setPinForm(f => ({ ...f, newPin: e.target.value })); setPinError('') }} placeholder="Min. 8 characters" autoComplete="new-password" />
              </div>
